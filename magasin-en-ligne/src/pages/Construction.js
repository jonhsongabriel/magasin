...
const Construction = () => {
  ...
  useEffect(() => {
    // Récupération des produits pour Construction
    axios
      .get('http://localhost:5000/api/produits?type=Construction')
      .then((response) => {
  ...
  if (produits.length === 0) {
    return <p>Aucun produit disponible pour les construction.</p>;
  }

  return (
    <div className="container mt-4">
      <h1 className="text-center">Produits des construction</h1>
      <div className="row">

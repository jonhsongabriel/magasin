...
const Mahajanga = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:5000/api/produits?lieu=Mahajanga')
      .then((response) => {
  ...
  if (produits.length === 0) {
    return <p>Aucun produit disponible pour Mahajanga.</p>;
  }

  return (
    <div className="container mt-4">
      <h1 className="text-center">Produits disponibles à Mahajanga</h1>
      <div className="row">

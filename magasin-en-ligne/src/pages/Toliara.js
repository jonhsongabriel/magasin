...
const Toliara = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:5000/api/produits?lieu=Toliara')
      .then((response) => {
  ...
  if (produits.length === 0) {
    return <p>Aucun produit disponible pour Toliara.</p>;
  }

  return (
    <div className="container mt-4">
      <h1 className="text-center">Produits disponibles à Toliara</h1>
      <div className="row">
